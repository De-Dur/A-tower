...
- Gradient-aware sphere generator that interpolates twist angles, layout scaling, and material colors per floor with multiple easing curves.
...
- **Sphere Radius / Spheres per Floor** - Control the size of each cluster and how many spheres appear on every tier.
